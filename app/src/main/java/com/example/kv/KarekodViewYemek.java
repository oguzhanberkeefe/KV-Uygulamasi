...
public class KarekodViewYemek extends AppCompatActivity {
    ...
    public void onBackPressed()
    {
        ...
        alertdialog.setCancelable(false).setPositiveButton("Evet", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent urunleregonder = new Intent(KarekodViewYemek.this,TemelKUygulamasi.class);
