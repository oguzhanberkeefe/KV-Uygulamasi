...
public class HavucDilimKekDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_havuc_dilim_kek_detay);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(HavucDilimKekDetay.this,KarekodViewYemek.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
