...
public class SnickersCaramelFrappeDetay extends AppCompatActivity {


    private Button sepeteekle;
    private TextView adetbirim,id2,isim,sutu,boyutu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snickers_caramel_frappe);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(SnickersCaramelFrappeDetay.this,KarekodViewEspresso.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
