...
public class VelvetCupcakeDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_velvet_cupcake_detay);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(VelvetCupcakeDetay.this,KarekodViewYemek.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
