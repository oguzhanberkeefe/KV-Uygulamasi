...
public class KarekodViewFiltreKahve extends AppCompatActivity {
    ...
    TextView id2,isim,boyut,surup,adet;
    ...
    public void onBackPressed()
    {
        ...
        alertdialog.setCancelable(false).setPositiveButton("Evet", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent urunleregonder = new Intent(KarekodViewFiltreKahve.this,TemelKUygulamasi.class);
