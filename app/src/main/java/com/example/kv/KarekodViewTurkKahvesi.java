...
public class KarekodViewTurkKahvesi extends AppCompatActivity {
    ...
    TextView id2,isim,boyut,seker,adet;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_karekod_view_turk_kahvesi);
        ...
        seker=(TextView)findViewById(R.id.seker);
        ...
        seker.setText(gelenVeri.getString("seker"));
        ...
        String seker2 = seker.getText().toString().trim();
        ...
        dbref.child(id23).child("seker").setValue(seker2);
    ...
    public void onBackPressed()
    {
        ...
        alertdialog.setCancelable(false).setPositiveButton("Evet", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent urunleregonder = new Intent(KarekodViewTurkKahvesi.this,TemelKUygulamasi.class);
