...
public class MozaikPastaDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mozaik_pasta_kek_detay);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(MozaikPastaDetay.this,KarekodViewYemek.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
