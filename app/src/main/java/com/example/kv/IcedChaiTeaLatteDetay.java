...
public class IcedChaiTeaLatteDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iced_chai_tea_latte);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(IcedChaiTeaLatteDetay.this,KarekodViewEspresso.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
