...
public class EspressoFrappeDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_espresso_frappe);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(EspressoFrappeDetay.this,KarekodView.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
