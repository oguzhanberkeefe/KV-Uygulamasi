...
public class BalkanCoregiDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_balkan_coregi_detay);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(BalkanCoregiDetay.this,KarekodViewYemek.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
