...
public class FlatWhiteDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(FlatWhiteDetay.this,KarekodView.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
