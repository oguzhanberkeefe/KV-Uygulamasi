...
public class BalKabakliLatteDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_balkabakli_latte);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                Intent karekod=new Intent(BalKabakliLatteDetay.this,KarekodView.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
