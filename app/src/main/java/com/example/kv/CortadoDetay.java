...
public class CortadoDetay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cortado);
        ...
        sepeteekle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent karekod=new Intent(CortadoDetay.this,KarekodView.class);///İntent ouşturup 2. activity'e gideceğini belirledik.
